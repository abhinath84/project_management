<?php
	...
	class TComponent 
	{
		...
		public function __construct($id = null, $class = null, $style = null, $attribute = null, $event = null)
		{	
			$this->_id 			= $id;
			$this->_classes 	= $class;
			$this->_style		= $style;
		...
		private function _format($attr, $val)
		{
			$str = "";
		...
		public function toString()
		{
			...
			// add ID
			$str .= "{$this->_padding($str)}{$this->_format('id', $this->_id)}";
			
			// add Classes
			$str .= "{$this->_padding($str)}{$this->_format('class', $this->_classes)}";
			
			// add Styles
			$str .= "{$this->_padding($str)}{$this->_format('style', $this->_style)}";
			
			// add Attributes
			$str .= "{$this->_padding($str)}{$this->_format('', $this->_attributes)}";
			
			// add Events
			$str .= "{$this->_padding($str)}{$this->_format('', $this->_events)}";
	...
	class TD
	{
		...
		public function __construct($val = null, $id = null, $class = null, $style = null, $attribute = null, $event = null)
		{
	...
	class TR
	{
		...
		public function Count()	{ return (count($this->_td)); }
	...
	class Tbody
	{
		...
		public function Count() { return (count($this->_tr)); }
	...
	class Thead
	{
		...
		public function th($val, $id = null, $class = null, $attribute = null)
		{
			$this->_th[$this->_node_id++] = new TD($val, $id, $class, $attribute);
		}
