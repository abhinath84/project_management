    ...
    function build_db()
    {
        ...
        $qry = "CREATE TABLE IF NOT EXISTS spr_tracking
                (
                    ...
                    status ENUM('NONE', 'INVESTIGATING','NOT AN ISSUE','SUBMITTED','RESOLVED','PASS FOR TESTING','CLOSED','ON HOLD', 'TESTING COMPLETE', 'PASS TO CORRESPONDING GROUP', 'NEED MORE INFO', 'OTHERS'),
