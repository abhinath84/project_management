<?php
    ...
    *   header tag string.
	*/
    function addHeader($selNav, $enableNav)
    {
        global $imagesPath;
        global $homeURL, $aboutURL, $contactURL;
		global $sprTrackingDashboardURL, $sprTrackingNewSPRURL, $sprTrackingSubmitStatusURL, $sprTrackingSearchURL;
		global $scrumDashboardURL, $scrumSearchURL;
        global $workTrackerDashboardURL;
        global $profileURL, $changePasswordURL, $logoutURL;
        global $loginURL, $signinURL;
        global $sprTrackingReportURL;
		...
		if($enableNav == true)
		{
			...
			$tag .= '			<div id="left-nav">';
			$tag .= '				<ul>';
			$tag .= '					<li ' . ($selNav == "HOME" ? 'class="selected"' : '') . '><a href="'. $homeURL .'" target="_top">HOME</a></li>';
			...
			$tag .= '						<ul>';
			$tag .= '	                    	<li ' . ($selNav == "SPR Tracking-Dashboard" ? 'class="selected"' : 'class="non-selected"') . '><a href="'. $sprTrackingDashboardURL .'" target="_top">Dashboard</a></li>'."\n";
			$tag .= '	                    	<li ' . ($selNav == "SPR Tracking-Submit Status" ? 'class="selected"' : 'class="non-selected"') . '><a href="'. $sprTrackingSubmitStatusURL .'" target="_top">Submit Status</a></li>'."\n";
			$tag .= '	                    	<li ' . ($selNav == "SPR Tracking-Report" ? 'class="selected"' : 'class="non-selected"') . '><a href="'. $sprTrackingReportURL .'" target="_top">Report</a></li>'."\n";
			$tag .= '						</ul>';
			$tag .= '					</li>';
			$tag .= '					<li ' . ($selNav == "Work Tracker" ? 'class="selected"' : '') . '><a href="'. $workTrackerDashboardURL .'" target="_top">Work Tracker</a></li>';
			$tag .= '					<li>';
			$tag .= '						<a href="">Scrum</a>';
			$tag .= '						<ul>'."\n";
			$tag .= '	                    	<li><a href="'. $scrumDashboardURL .'" target="_top">Dashboard</a></li>'."\n";
			$tag .= '	                    	<li>'."\n";
			$tag .= '								<a href="" target="_top">Sprint</a>'."\n";
			$tag .= '                    			<ul>'."\n";
			$tag .= '	                    			<li><a href="'. $sprTrackingDashboardURL .'" target="_top">Dashboard</a></li>'."\n";
			$tag .= '	                    			<li><a href="'. $sprTrackingNewSPRURL .'" target="_top">Add SPR</a></li>'."\n";
			$tag .= '	                    			<li><a href="'. $sprTrackingSubmitStatusURL .'" target="_top">Submit Status</a></li>'."\n";
			$tag .= '	                    			<li><a href="'. $sprTrackingSearchURL .'" target="_top">Search</a></li>'."\n";
			$tag .= '                    			</ul>'."\n";
			$tag .= '							</li>'."\n";
			$tag .= '	                    <li ' . ($selNav == "Search" ? 'class="selected"' : '') . '><a href="'. $scrumSearchURL .'" target="_top">Search</a></li>'."\n";
			$tag .= '                    	</ul>'."\n";
			$tag .= '					</li>';
			$tag .= '                	<li ' . ($selNav == "About" ? 'class="selected"' : '') . '><a href="'. $aboutURL .'" target="_top">About</a></li>'."\n";
			$tag .= '                	<li ' . ($selNav == "Contact us" ? 'class="selected"' : '') . '><a href="'. $contactURL .'" target="_top">Contact us</a></li>'."\n";;
			$tag .= '				</ul>';
			$tag .= '			</div>';
			...
			if((isset($_SESSION['project-managment-username'])) && ($_SESSION['project-managment-username'] != ""))
			{
				...
				$tag .= '	                    	<li><a href="'. $profileURL .'" target="_top">Profile</a></li>'."\n";
				$tag .= '	                    	<li><a href="'. $changePasswordURL .'" target="_top">Change Password</a></li>'."\n";
				$tag .= '                			<li><a href="'. $logoutURL .'" target="_top">Logout</a></li>'."\n";
				$tag .= '						</ul>';
				$tag .= '					</li>';
			}
			else
			{
				$tag .= '                <li><a href="'. $loginURL .'" target="_top">Login</a></li>'."\n";
				$tag .= '                <li><a href="'. $signinURL .'" target="_top">Sign Up</a></li>'."\n";
			}
    ...
    *   header tag string.
	*/
    function addFooter($hrTagFlag = true)
    {
        global $imagesPath;
        global $homeURL, $aboutURL, $copyrightURL, $privacyURL;
        ...
        $tag .= '        <a id="footer-logo" class="footer-logo" href="'. $homeURL .'"><img style="border:0" src="'. $imagesPath .'/ptc-small.gif" alt="ptc.com"></a>'."\n";
        $tag .= '        <nav class="footer-nav">'."\n";
        $tag .= '            <a href="'. $homeURL .'">HOME</a> |'."\n";
        $tag .= '            <a class="up">TOP</a> |'."\n";
        $tag .= '            <a href="'. $aboutURL .'">ABOUT</a>'."\n";
        $tag .= '        </nav>'."\n";
        ...
        $tag .= '            <a href="'. $copyrightURL .'">terms of use</a> and <a href="'. $privacyURL .'">privacy policy</a>.<br>'."\n";
        $tag .= '            <a href="'. $copyrightURL .'">Copyright 1999-2014</a> by Abhishek Nath. All Rights Reserved.<br><br>'."\n";
        $tag .= '        </div>'."\n";
        $tag .= '   </div>'."\n";
	...
	{
		global $imagesPath, $sprTrackingDashboardURL, $sprTrackingSubmitStatusURL, $workTrackerDashboardURL;
